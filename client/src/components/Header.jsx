            ...
            <header className="bg-[url('/img/banner-bg.jpg')] text-white bg-cover bg-center py-8">
                <nav className="container mx-auto bg-white border-gray-200  rounded-lg">
                    <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                        <Link className="flex items-center space-x-3 rtl:space-x-reverse" to="/" data-discover="true">
                            <img className="h-8" alt="Karma Logo" src="/img/logo.png" />
                        </Link>
                ...
                <div className="container hidden md:block mx-auto text-end px-8 py-28 relative z-0">
                    ...
                    <nav className="text-sm space-x-2 "><Link className="hover:underline font-bold" to="/" data-discover="true">Home</Link>
                        {title && (
                            <div>
